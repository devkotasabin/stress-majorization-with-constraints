...
# Construct LV and D matrix for revisited portion
# They don't change between iterations for now
# V = np.array([
# 		[0, 100, 100, 100, 0],
# 		[100, 0, 100, 100, 0],
# 		[100, 100, 0, 100, 0],
...
LV = -V
diagLV = np.diag(np.sum(V, axis = 1))
LV = LV + diagLV
...
# Start the normal stress normalization
...
X_curr =  np.linalg.lstsq(LLV, b + LVD)[0]
